...
if [[ ${PV} == *9999 ]]; then
	...
	SRC_URI="https://download.qt.io/official_releases/QtForPython/pyside2/PySide2-${PV}-src/${PN}-setup-opensource-src-${PV}.tar.xz"
	KEYWORDS="~amd64 ~x86"
fi
...
S=${WORKDIR}/${PN}-setup-opensource-src-${PV}/sources/pyside2
